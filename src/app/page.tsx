...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="max-w-[1440px] max-h-[1024px] w-screen h-screen object-cover bg-center bg-hero-bg flex-col justify-start items-center gap-2.5 inline-flex"> <div className="self-stretch h-[318px] p-6 flex-col justify-start items-center gap-10 flex">
